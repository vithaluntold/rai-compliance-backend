...
# from routes.ai_parser_router import router as ai_parser_router  # Disabled - Flask conflict
...
# app.include_router(ai_parser_router, prefix="/api/v1/ai-parser", tags=["ai-parser"])  # Disabled - Flask conflict
